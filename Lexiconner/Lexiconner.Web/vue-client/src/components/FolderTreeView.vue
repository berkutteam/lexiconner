<template>
  ...
  >
    <li>
      <div v-bind:class="{ 'font-weight-bold': false }" class="tree-item">
        <!-- Expand button or placeholder -->
        <span
          v-if="hasChildren"
          v-on:click="toggle"
          class="tree-item-toggle mr-1"
        >
        ...
        <span class="tree-item-name" v-on:click="folderClicked(treeItem)">
          ...
          <span
            v-bind:class="{
              'font-weight-bold': treeItem.id === activeTreeItemId,
            }"
          >
            {{ treeItem.name }}
          </span>
        ...
        <span class="dropdown ml-2">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            ...
            >
              <i
                class="fas fa-folder-plus text-secondary mr-1"
                style="width: 20px"
              ></i>
            ...
            >
              <i
                class="fas fa-edit text-secondary mr-1"
                style="width: 20px"
              ></i>
            ...
            >
              <i
                class="fas fa-plus-square text-secondary mr-1"
                style="width: 20px"
              ></i>
              <span>Add item</span>
            </a>
            ...
            >
              <i
                class="far fa-copy text-secondary mr-1"
                style="width: 20px"
              ></i>
            ...
            >
              <i
                class="fas fa-folder-minus text-secondary mr-1"
                style="width: 20px"
              ></i>
...
export default {
  ...
  computed: {
    ...
    hasChildren: function () {
      return this.treeItem.children && this.treeItem.children.length > 0;
    },
