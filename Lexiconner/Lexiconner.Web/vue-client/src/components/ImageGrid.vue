<template>
      <div v-if="images" class="image-grid mb-2" v-bind:class="{[`image-grid--${columnsCount}-columns`]: true}">
        <div class="image-grid-row">
            ...
            >
                <div
                    ...
                    v-bind:class="{'image-container--selected': checkImageSelected(image)}"
                >
...
export default {
    ...
    methods: {
        ...
        selectImageById: function(id) {
            const image = this.images.find(x => x.id === id || x.randomId === id) || null;
        ...
        getColumnImages: function(columnIndex) {
            ...
            const images = this.images.slice(columnIndex * perColumn, columnIndex * perColumn + perColumn);
            return images;
        },
        onImageClick: function(image) {
            ...
            if(this.onSelectedImagesChange) {
                this.onSelectedImagesChange(Object.values(this.privateState.selectedImages));
            }
        },
    },
}
