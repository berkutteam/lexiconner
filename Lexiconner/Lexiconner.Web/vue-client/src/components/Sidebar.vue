  ...
  <div id="sidebar" class="app-sidebar no-print">
    ...
    <div v-if="sharedState.auth.isAuthenticated">
          ...
          <div class="d-flex justify-content-start align-items-start">
            <div class="mr-3">
              <img
                ...
                src="img/user.png"
                v-bind:alt="
                  sharedState.auth.user.profile.name ||
      ...
      <div v-if="sharedState.auth.isAuthenticated" class="sidebar-item">
        <router-link
          v-bind:to="{ name: 'user-dictionary' }"
          v-on:click.native="handleNavLinkClick()"
          class="sidebar-link"
        >
      ...
      <div v-if="sharedState.auth.isAuthenticated" class="sidebar-item">
        <router-link
          v-bind:to="{ name: 'trainings-dashboard' }"
          v-on:click.native="handleNavLinkClick()"
          class="sidebar-link"
        >
      ...
      <div v-if="sharedState.auth.isAuthenticated" class="sidebar-item">
        <router-link
          v-bind:to="{ name: 'user-films-browse' }"
          v-on:click.native="handleNavLinkClick()"
          class="sidebar-link"
        >
