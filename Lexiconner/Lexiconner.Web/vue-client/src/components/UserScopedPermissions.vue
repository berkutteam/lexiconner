        ...
        <div class="mb-1">
            ...
            >
              (<router-link
                v-bind:to="{
                  ...
                  params: {
                    companyId: userPermissions.scopeId,
                    userId: userId,
                  },
                }"
                class=""
          ...
          <div class="list-group mb-1">
            <li class="list-group-item list-group-item-primary">
              ...
              >
                <small>
                  {{ permissionDisplay.name }} /
                  {{ permissionDisplay.description }}
                </small>
              </p>
            </li>
          </div>
