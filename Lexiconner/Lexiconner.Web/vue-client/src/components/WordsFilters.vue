    ...
    <form v-on:submit.prevent="() => {}" class="form-inline">
      ...
      <div class="form-group mr-3 cursor-pointer">
        ...
        <i
          ...
          v-on:click="
            setIsFavorite(!sharedState.wordsRequestParams.isFavourite)
          "
      ...
      <div class="form-group mr-3 cursor-pointer">
        <div class="form-check form-check-inline">
          <input
            v-on:change="(e) => setIsTrained(e.target.checked ? true : null)"
            id="inlineCheckbox1"
        ...
        <div class="form-check form-check-inline mr-0">
          <input
            v-on:change="(e) => setIsTrained(e.target.checked ? false : null)"
            id="inlineCheckbox2"
            class="form-check-input"
            type="checkbox"
            value="option2"
      ...
      <div class="form-group mr-3 cursor-pointer">
        <i
          ...
          v-bind:class="{
            'text-info': sharedState.wordsRequestParams.isShuffle === true,
          }"
          class="fas fa-random"
        ></i>
      </div>
