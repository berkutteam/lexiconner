  ...
  return new Promise((resolve, reject) => {
    authService.getUser().then(
      (user) => {
        ...
        axiosConfig.headers[
          "Authorization"
        ] = `${authenticationScheme} ${access_token}`;
...
class API {
  ...
  configApi() {
    ...
    return {
      config: () => {
        return axiosRequest({ url: url, method: "get" })
  ...
  webApi() {
    ...
    return {
      ...
      findNextWordImages({ wordId }) {
        return axiosAuthRequest({
          url: buildUrl(url, `words/${wordId}/images/find`, {}),
          method: "post",
          data: {},
        })
          .then(handleApiResponse)
      ...
      updateWordImages({ wordId, data }) {
        return axiosAuthRequest({
          url: buildUrl(url, `words/${wordId}/images`, {}),
          method: "put",
          data: { ...data },
        })
          .then(handleApiResponse)
      ...
      addWordToFavourites({ wordId }) {
        return axiosAuthRequest({
          url: buildUrl(url, `words/${wordId}/favourites`, {}),
          method: "post",
          data: {},
        })
          .then(handleApiResponse)
      ...
      getWordExamples({ languageCode, word }) {
        return axiosAuthRequest({
          url: buildUrl(url, `words/examples`, { languageCode, word }),
          method: "get",
        })
          .then(handleApiResponse)
          .catch(handleApiErrorResponse);
      ...
      getWordPronunciationAudio({ languageCode, word }) {
        return axiosAuthRequest({
          url: buildUrl(url, `words/pronunciation/audio`, {
            languageCode,
            word,
          }),
          method: "get",
      ...
      findImagesByLanguage({ languageCode, search, limit }) {
        return axiosAuthRequest({
          url: buildUrl(url, `images/find/by-language`, {
            languageCode,
            search,
            limit,
          }),
      ...
      getTrainingStatistics({ userWordSetId }) {
        return axiosAuthRequest({
          url: buildUrl(url, `words/trainings/stats`, { userWordSetId }),
          method: "get",
        })
          .then(handleApiResponse)
          .catch(handleApiErrorResponse);
      ...
      markWordAsTrained({ wordId }) {
        return axiosAuthRequest({
          url: buildUrl(url, `words/trainings/trained/${wordId}`, {}),
          method: "put",
        })
          .then(handleApiResponse)
          .catch(handleApiErrorResponse);
      ...
      markWordAsNotTrained({ wordId }) {
        return axiosAuthRequest({
          url: buildUrl(url, `words/trainings/not_trained/${wordId}`, {}),
          method: "put",
        })
          .then(handleApiResponse)
          .catch(handleApiErrorResponse);
      },
      flashcardsTrainingStart({ collectionId, userWordSetId, limit }) {
        return axiosAuthRequest({
          url: buildUrl(url, `words/trainings/flashcards`, {
            collectionId,
            userWordSetId,
            limit,
          }),
      ...
      flashcardsTrainingSave({ data }) {
        return axiosAuthRequest({
          url: buildUrl(url, `words/trainings/flashcards/save`, {}),
          method: "post",
          data: { ...data },
        })
          .then(handleApiResponse)
      ...
      wordmeaningTrainingStart({ collectionId, userWordSetId, limit }) {
        return axiosAuthRequest({
          url: buildUrl(url, `words/trainings/wordmeaning`, {
            collectionId,
            userWordSetId,
            limit,
          }),
      ...
      wordmeaningTrainingSave({ data }) {
        return axiosAuthRequest({
          url: buildUrl(url, `words/trainings/wordmeaning/save`, {}),
          method: "post",
          data: { ...data },
        })
          .then(handleApiResponse)
      ...
      meaningwordTrainingStart({ collectionId, userWordSetId, limit }) {
        return axiosAuthRequest({
          url: buildUrl(url, `words/trainings/meaningword`, {
            collectionId,
            userWordSetId,
            limit,
          }),
      ...
      meaningwordTrainingSave({ data }) {
        return axiosAuthRequest({
          url: buildUrl(url, `words/trainings/meaningword/save`, {}),
          method: "post",
          data: { ...data },
        })
          .then(handleApiResponse)
      ...
      matchwordsTrainingStart({ collectionId, userWordSetId }) {
        return axiosAuthRequest({
          url: buildUrl(url, `words/trainings/matchwords`, {
            collectionId,
            userWordSetId,
          }),
          method: "get",
      ...
      matchwordsTrainingSave({ data }) {
        return axiosAuthRequest({
          url: buildUrl(url, `words/trainings/matchwords/save`, {}),
          method: "post",
          data: { ...data },
        })
          .then(handleApiResponse)
      ...
      buildwordsTrainingStart({ collectionId, userWordSetId, limit }) {
        return axiosAuthRequest({
          url: buildUrl(url, `words/trainings/buildwords`, {
            collectionId,
            userWordSetId,
            limit,
          }),
      ...
      buildwordsTrainingSave({ data }) {
        return axiosAuthRequest({
          url: buildUrl(url, `words/trainings/buildwords/save`, {}),
          method: "post",
          data: { ...data },
        })
          .then(handleApiResponse)
      ...
      listenwordsTrainingStart({ collectionId, userWordSetId, limit }) {
        return axiosAuthRequest({
          url: buildUrl(url, `words/trainings/listenwords`, {
            collectionId,
            userWordSetId,
            limit,
          }),
      ...
      listenwordsTrainingSave({ data }) {
        return axiosAuthRequest({
          url: buildUrl(url, `words/trainings/listenwords/save`, {}),
          method: "post",
          data: { ...data },
        })
          .then(handleApiResponse)
      ...
      getCustomCollections() {
        return axiosAuthRequest({
          url: buildUrl(url, `customcollections`, {}),
          method: "get",
        })
          .then(handleApiResponse)
          .catch(handleApiErrorResponse);
      ...
      updateCustomCollection({ customCollectionId, data }) {
        return axiosAuthRequest({
          url: buildUrl(url, `customcollections/${customCollectionId}`, {}),
          method: "put",
          data: { ...data },
        })
          .then(handleApiResponse)
      ...
      markCustomCollectionAsSelected({ customCollectionId }) {
        return axiosAuthRequest({
          url: buildUrl(
            url,
            `customcollections/${customCollectionId}/select`,
            {}
          ),
          method: "put",
          data: {},
      ...
      duplicateCustomCollection({ customCollectionId }) {
        return axiosAuthRequest({
          url: buildUrl(
            url,
            `customcollections/${customCollectionId}/duplicate`,
            {}
          ),
          method: "post",
          data: {},
      ...
      getUserDictionary({ languageCode }) {
        return axiosAuthRequest({
          url: buildUrl(url, `userdictionary/${languageCode}`, {}),
          method: "get",
        })
          .then(handleApiResponse)
          .catch(handleApiErrorResponse);
      ...
      addWordSetToUserDictionary({ languageCode, wordSetId, selectedWordIds }) {
        return axiosAuthRequest({
          url: buildUrl(
            url,
            `userdictionary/${languageCode}/wordsets/add-from-wordset`,
            {}
          ),
          method: "post",
          data: { wordSetId, selectedWordIds },
        })
          .then(handleApiResponse)
          .catch(handleApiErrorResponse);
      },
      createUserDictionaryWordSet({ languageCode, data }) {
        return axiosAuthRequest({
          url: buildUrl(url, `userdictionary/${languageCode}/wordsets`, {}),
          method: "post",
          data: { ...data },
        })
          .then(handleApiResponse)
      ...
      updateUserDictionaryWordSet({ languageCode, wordSetId, data }) {
        return axiosAuthRequest({
          url: buildUrl(
            url,
            `userdictionary/${languageCode}/wordsets/${wordSetId}`,
            {}
          ),
          method: "put",
          data: { ...data },
      ...
      getUserFilms({ offset, limit, search }) {
        return axiosAuthRequest({
          url: buildUrl(url, `userfilms`, { offset, limit, search }),
          method: "get",
        })
          .then(handleApiResponse)
          .catch(handleApiErrorResponse);
      ...
      getUserFilm({ userFilmId }) {
        return axiosAuthRequest({
          url: buildUrl(url, `userfilms/${userFilmId}`, {}),
          method: "get",
        })
          .then(handleApiResponse)
          .catch(handleApiErrorResponse);
