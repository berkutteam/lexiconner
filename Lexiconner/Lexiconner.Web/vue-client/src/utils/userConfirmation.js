...
class UserConfirmationUtil {
  ...
  handleUserConfirmationFlow({ actionF }) {
    return this._handleUserConfirmationFlow({
      actionF,
      userConfirmationRequest: null,
    });
  }
  ...
  _handleUserConfirmationFlow({
    ...
    let initialConfirm = userConfirmationRequest
      ? true
      : window.confirm("Are you sure?");
    if (initialConfirm) {
      // call action (server API)
      return actionF({ userConfirmation: userConfirmationRequest })
        .then((responseData) => {
