  ...
  <div class="dashboard-wrapper">
    ...
    <div v-if="$store.getters.currentCompanyId">
      <ul class="nav nav-tabs app-nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
          <router-link
            v-bind:to="{ name: 'dashboard-home', params: {} }"
            v-bind:class="{
              active: $router.currentRoute.name === 'dashboard-home',
            }"
            class="nav-link"
        ...
        <li class="nav-item">
          <router-link
            v-bind:to="{
              ...
              params: { companyId: $store.getters.currentCompanyId },
            }"
            v-bind:class="{
              active: $router.currentRoute.name === 'dashboard-gateways',
            }"
            class="nav-link"
        ...
        <li class="nav-item">
          <router-link
            ...
            v-bind:class="{
              active: $router.currentRoute.name === 'dashboard-sensors',
            }"
            class="nav-link"
            >Sensors</router-link
          >
        ...
        <li class="nav-item">
          <router-link
            ...
            v-bind:class="{
              active: $router.currentRoute.name === 'dashboard-departments',
            }"
            class="nav-link"
        ...
        >
          <router-link
            ...
            v-bind:class="{
              active: $router.currentRoute.name === 'dashboard-users',
            }"
            class="nav-link"
            >Users</router-link
          >
      ...
      <div
        v-if="sharedState.userInfo"
        class="tab-content app-tab-content"
        id="myTabContent"
      >
