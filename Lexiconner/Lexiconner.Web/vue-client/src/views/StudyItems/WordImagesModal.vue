        ...
        >
            <div class="app-modal">
                ...
                <div class="app-modal-content">
                    <row-loader v-bind:visible="sharedState.loading[privateState.storeTypes.WORD_IMAGES_FIND]" class="mb-2"></row-loader>
                    ...
                    <form v-on:submit.prevent="onUpdateWordImagesClick()">
                        ...
                        <div class="form-group mt-2">
                            <label for="studyItemModel__description">Add image by URL</label>
...
export default {
    ...
    methods: {
        ...
        findNextWordImages: function({ wordId }) {
            this.$store.dispatch(storeTypes.WORD_IMAGES_FIND, {
                wordId,
            }).then(() => {
            }).catch(err => {
                console.error(err);
        ...
        updateWordImages: function({ wordId, images }) {
            this.$store.dispatch(storeTypes.WORD_IMAGES_UPDATE, {
                wordId,
                data: {
                    images,
                },
