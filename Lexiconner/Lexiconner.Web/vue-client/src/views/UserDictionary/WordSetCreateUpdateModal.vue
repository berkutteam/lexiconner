        ...
        <div class="app-modal-header">
          <div class="app-modal-title">
            <span v-if="privateState.modalMode === 'create'"
              >Create word set</span
            >
            <span v-if="privateState.modalMode === 'edit'">Edit word set</span>
          </div>
          <div
            v-on:click="$modal.hide('word-set-create-edit')"
        ...
        <div class="app-modal-content">
          ...
          <form v-on:submit.prevent="createEditWordSet()">
            ...
            <loading-button
              ...
              v-bind:loading="
                sharedState.loading[
                  privateState.storeTypes.USER_DICTIONARY_WORD_SET_CREATE
                ] ||
                sharedState.loading[
                  privateState.storeTypes.USER_DICTIONARY_WORD_SET_UPDATE
                ]
              "
...
export default {
    ...
    this.unwatch = this.$store.watch(
      ...
      (newValue, oldValue) => {
        if (this.privateState.modalMode === "edit") {
          ...
          const wordSet =
            userDictionary.wordSets.find(
              (x) => x.id === this.privateState.wordSetEditingId
            ) || null;
  ...
  methods: {
    ...
    createWordSet: function () {
      this.$store
        .dispatch(storeTypes.USER_DICTIONARY_WORD_SET_CREATE, {
          data: {
            ...this.privateState.wordSetModel,
          },
        })
    ...
    updateWordSet: function () {
      this.$store
        .dispatch(storeTypes.USER_DICTIONARY_WORD_SET_UPDATE, {
