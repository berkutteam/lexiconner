    ...
    <div class="row">
      <div class="col-12">
        <div v-if="userFilms" class="user-films-wrapper">
          ...
          >
            <div class="btn-group mr-2" role="group" aria-label="View toggle">
              <button
                ...
                v-bind:class="{
                  'btn-primary': privateState.currentView === 'list',
                  'btn-secondary': privateState.currentView !== 'list',
                }"
                type="button"
                class="btn"
              >
              ...
              <button
                v-on:click="toggleView"
                v-bind:class="{
                  'btn-primary': privateState.currentView === 'cards',
                  'btn-secondary': privateState.currentView !== 'cards',
                }"
                type="button"
                class="btn"
              >
          ...
          <!-- Filters -->
          <user-films-filters v-bind:onChange="loadUserFilms">
          </user-films-filters>

          <row-loader
            v-bind:visible="
              sharedState.loading[privateState.storeTypes.USER_FILMS_LOAD]
            "
          />
          ...
          <div>
            ...
            >
              <!-- List view -->
              <div
                v-if="privateState.currentView === 'list'"
                class="list-group user-items-list"
              >
                <a
                ...
                >
                  <div class="d-flex w-100 justify-content-between">
                    ...
                    <div>
                      ...
                      <span>
                        <span
                          v-on:click="onUpdateUserFilm(item.id)"
                          class="badge badge-secondary mr-1 cursor-pointer"
                        >
                          <i class="fas fa-pencil-alt"></i>
                        </span>
                        <span
                          v-on:click="onDeleteUserFilm(item.id)"
                  ...
                  <div class="small">
                    ...
                    <div v-if="item.watchedAt">
                      ...
                      <span class="mr-1">{{
                        moment(item.watchedAt).format("YYYY-MM-DD")
                      }}</span>
                    </div>
              ...
              >
                ...
                >
                  ...
                  <img
                    v-if="item.details && item.details.image"
                    class="card-img-top item-card-image"
                    v-bind:src="item.details.image.posterUrl"
                  />
                  <img
                    v-else
                    class="card-img-top item-card-image"
        ...
        >
          <div class="app-modal">
            <div class="app-modal-header">
              ...
              <div
                v-on:click="$modal.hide('user-film-create-edit')"
            ...
            <div class="app-modal-content">
              <form
                v-on:submit.prevent="createEditUserFilm(privateState.modalMode)"
              >
                <div class="form-group">
                  <label for="userFilmModel__title">Title</label>
                  <input
                    v-model="privateState.userFilmModel.title"
                    type="text"
                    class="form-control"
                    id="userFilmModel__title"
                    placeholder="Title"
                  />
                </div>
                <div class="form-group">
                  ...
                  <input
                    v-model="privateState.userFilmModel.myRating"
                    type="number"
                    step="0.1"
                    class="form-control"
                    id="userFilmModel__myRating"
                ...
                <div class="form-group">
                  ...
                  <input
                    v-model="privateState.userFilmModel.releaseYear"
                    type="number"
                    step="1"
                    class="form-control"
                    id="userFilmModel__releaseYear"
                ...
                <div class="form-group">
                  ...
                  <input
                    v-model="privateState.userFilmModel.comment"
                    type="text"
                    class="form-control"
                    id="userFilmModel__comment"
                    placeholder="Comment"
                  />
                </div>
                <div class="form-group">
                  <label for=""
                    ...
                    <small class="text-muted"
                      >(of entered data, not a film)</small
                    ></label
                  >
                ...
                <loading-button
                  ...
                  v-bind:loading="
                    sharedState.loading[
                      privateState.storeTypes.USER_FILM_CREATE
                    ] ||
                    sharedState.loading[
                      privateState.storeTypes.USER_FILM_UPDATE
                    ]
                  "
...
export default {
  ...
  computed: {
    ...
    ...mapState({
      ...
      userFilms: (state) =>
        state.userFilmsPaginationResult
          ? state.userFilmsPaginationResult.items
          : null,
    }),
  },
  created: function () {
  ...
  methods: {
    loadUserFilms: function ({ offset = 0, limit = 50 } = {}) {
      return this.$store
        .dispatch(storeTypes.USER_FILMS_LOAD, {
          offset: offset,
          limit: limit,
        })
        .then()
    ...
    toggleView: function () {
      this.privateState.currentView =
        this.privateState.currentView === "list" ? "cards" : "list";
    },
    ...
    createUserFilm: function () {
      this.$store
        .dispatch(storeTypes.USER_FILM_CREATE, {
          data: {
    ...
    updateUserFilm: function () {
      this.$store
        .dispatch(storeTypes.USER_FILM_UPDATE, {
    ...
    deleteUserFilm: function (userFilmId) {
      this.$store
        .dispatch(storeTypes.USER_FILM_DELETE, {
