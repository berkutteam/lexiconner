<template>
    <div class="user-profile-wrapper">
        <row-loader v-bind:visible="sharedState.loading[privateState.storeTypes.AUTH_USER_ACCOUNT_LOAD] || sharedState.loading[privateState.storeTypes.USER_INFO_LOAD]"></row-loader>
                            ...
                            <div class="d-flex w-100 justify-content-start align-items-center">
                                <div class="w-100">
                                    <form v-on:submit.prevent="updateUser">
                                                ...
                                                <div class="media-body">
                                                    <div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div>{{ sharedState.auth.user.profile.email }}</div>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for=""><strong>Given name (username)</strong></label>
                                                            <div>{{ sharedState.auth.user.profile.given_name }}</div>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="userInfoModel__phone"><strong>Phone</strong></label>
                                                            <vue-tel-input 
                                                                v-model="privateState.userAccountModel.phoneNumber"
                                                        ...
                                                        <div v-if=isPhoneChanged class="form-group">
                                                            <div>
                                                                <label for="userInfoModel__phoneNumberConfirmationToken"><strong>Phone confirmation</strong></label>
                                                                <loading-button 
                                                                    type="button"
                                                                    v-bind:loading="sharedState.loading[privateState.storeTypes.AUTH_USER_ACCOUNT_PHONE_CHANGE_SMS_TOKEN_SEND]"
                                                                    v-on:click.native="sendSmsPhoneNumberChangeToken"
                                                                    class="btn btn-outline-secondary btn-sm ml-2"
                                                                >Send confirmation code</loading-button>
                                                            </div>
                                                            <input v-model="privateState.userAccountModel.phoneNumberConfirmationToken" id="userInfoModel__phoneNumberConfirmationToken" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <loading-button 
                                            type="submit"
                                            v-bind:loading="sharedState.loading[privateState.storeTypes.AUTH_USER_ACCOUNT_UPDATE]"
                            ...
                            <div class="d-flex w-100 justify-content-start align-items-center">
                                <div class="w-100">
                                    <form v-on:submit.prevent="updateUserInfo">
                                         <div class="form-group">
                                            <label for="userInfoModel__name"><strong>Name</strong></label>
                                            <input v-model="privateState.userInfoModel.name" id="userInfoModel__name" type="text" class="form-control">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="userInfoModel__language"><strong>Language</strong></label>
                                            <multiselect 
                                        ...
                                        <div class="form-group">
                                            <label for="userInfoModel__country"><strong>Country</strong></label>
                                            <multiselect 
                                         ...
                                         <div class="form-group">
                                            <label for="userInfoModel__timeZone"><strong>Timezone</strong></label>
                                            <multiselect 
                                            ...
                                            <div><small>UTC is used by default if timezone isn't set.</small></div>
                                        </div>
                                        <loading-button 
                                            type="submit"
                                            v-bind:loading="sharedState.loading[privateState.storeTypes.USER_INFO_UPDATE]"
                                            class="btn btn-outline-success"
                                        >Save</loading-button>
                                    </form>
                                </div>
                                ...
                                <div class="w-100">
                                    <form v-on:submit.prevent="updateNotifications">
                                        <div class="form-group form-check">
                                            <input v-model="privateState.notificationsModel.isAlarmEnabled" id="isAlarmEnabled" type="checkbox" class="form-check-input">
                                            <label class="form-check-label" for="isAlarmEnabled">Alarm enabled</label>
                                        </div>
                                        <div class="form-group form-check">
                                            <input v-model="privateState.notificationsModel.isAlarmSoundEnabled" id="isAlarmSoundEnabled" type="checkbox" class="form-check-input">
                                            <label class="form-check-label" for="isAlarmSoundEnabled">Alarm sound</label>
                                        </div>
                                        <div class="form-group form-check">
                                            <input v-model="privateState.notificationsModel.isDoNotDisturbEnabled" id="isDoNotDisturbEnabled" type="checkbox" class="form-check-input">
                                            <label class="form-check-label" for="isDoNotDisturbEnabled">Do not disturb</label>
                                        </div>
                                        <div v-if="privateState.notificationsModel.isDoNotDisturbEnabled" class="form-group">
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label for="doNotDisturbFrom">From</label>
                                                        <time-input
                                                            v-model="privateState.notificationsModel.doNotDisturbFrom"
                                                        />
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <time-input
                                                            v-model="privateState.notificationsModel.doNotDisturbTo"
                                                        />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <loading-button 
                                            type="submit"
                                            v-bind:loading="sharedState.loading[privateState.storeTypes.USER_INFO_NOTIFICATIONS_UPDATE]"
                                            class="btn btn-outline-success"
                                        >Save</loading-button>
                                    </form>
                                </div>
                                ...
                                <div class="w-100">
                                    ...
                                    <form v-on:submit.prevent="changePassword">
                                        <div class="form-group">
                                            ...
                                            <input v-model="privateState.passwordChangeModel.passwordOld" type="password" class="form-control" placeholder="Old password" autocomplete="new-password">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputPassword">New password</label>
                                            <input v-model="privateState.passwordChangeModel.passwordNew" type="password" class="form-control" placeholder="New password" autocomplete="new-password">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputPasswordConfirm">Confirm new password</label>
                                            <input v-model="privateState.passwordChangeModel.passwordNewConfirm" type="password" class="form-control" placeholder="Confirm new password" autocomplete="new-password">
                                        </div>
                                        <loading-button 
                                            type="submit"
                                            v-bind:loading="sharedState.loading[privateState.storeTypes.AUTH_USER_PASSWORD_CHANGE]"
                        ...
                        <li class="list-group-item border-danger">
                            <div class="d-flex w-100 justify-content-between align-items-center">
                                <div class="text-danger">
                                    ...
                                    <div><small>You account and all related data will be deleted!</small></div>
                                    <div><small>NB: This action is irreversible!</small></div>
                                </div>
                                <loading-button 
                                    type="button"
                                    v-bind:loading="sharedState.loading[privateState.storeTypes.AUTH_USER_ACCOUNT_DELETE]"
                                    class="btn-danger"
...
export default {
    ...
    computed: {
        ...
        isPhoneChanged: function() {
            return this.privateState.userAccountModel.phoneNumber !== ((this.sharedState.userAccount || {}).phoneNumber || null);
        },
    },
    ...
    methods: {
        onPhoneNumberValidate({ number, isValid, country }) {
            let {e164, input, international, national, rfc3966, significant} = number;
        ...
        timeZoneLabel(option) {
            return `${option.timeZoneId} (${option.countryName} / ${option.countryCode} ${option.comment ? `/ ${option.comment}` : ''})`;
        },
        ...
        sendSmsPhoneNumberChangeToken: function() {
            this.$store.dispatch(storeTypes.AUTH_USER_ACCOUNT_PHONE_CHANGE_SMS_TOKEN_SEND, {
        ...
        updateUser: function() {
            this.$store.dispatch(storeTypes.AUTH_USER_ACCOUNT_UPDATE, {
                data: {
                    phoneNumber: this.privateState.userAccountModel.phoneNumber,
                    phoneNumberConfirmationToken: this.privateState.userAccountModel.phoneNumberConfirmationToken,
                },
            }).then(() => {
                this.privateState.userAccountModel.phoneNumberConfirmationToken = null;
        ...
        updateUserInfo: function() {
            this.$store.dispatch(storeTypes.USER_INFO_UPDATE, {
                data: {
        ...
        updateNotifications: function() {
            this.$store.dispatch(storeTypes.USER_INFO_NOTIFICATIONS_UPDATE, {
                data: {
                    ...this.privateState.notificationsModel,
                },
            }).then(() => {
        ...
        changePassword: function() {
            this.$store.dispatch(storeTypes.AUTH_USER_PASSWORD_CHANGE, {
        ...
        deleteAccount: function() {
            userConfirmationUtil.handleUserConfirmationFlow({
                actionF: ({userConfirmation}) => {
                    return this.$store.dispatch(storeTypes.AUTH_USER_ACCOUNT_DELETE, {userConfirmation});
                },
            }).then(({isProcessed}) => {
                if(isProcessed) {
                    // deleted
