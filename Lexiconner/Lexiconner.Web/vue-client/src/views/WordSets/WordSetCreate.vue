    ...
    <div class="container">
        ...
        <form v-on:submit.prevent="createEditWordSet()">
            <div class="form-group">
                ...
                <input v-model="privateState.wordSetModel.name" type="text" class="form-control" placeholder="Name" />
            </div>
            <div class="form-group">
                ...
                />
                <small class="form-text text-muted">Specify language for words in the set.</small>
            </div>
            <div class="form-group">
                ...
                />
                <small class="form-text text-muted">Specify language for words' meanings.</small>
            </div>
            ...
            <div>
                ...
                >
                    <div class="col">
                        <input v-model="privateState.wordSetModel.words[wordIndex].word" type="text" class="form-control form-control-sm" placeholder="Word">
                    </div>
                    <div class="col">
                        <input v-model="privateState.wordSetModel.words[wordIndex].meaning" type="text" class="form-control form-control-sm" placeholder="Meaning">
                    </div>
                    <div class="col">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                ...
                                >
                                    <textarea 
                                        v-model="privateState.wordSetModel.words[wordIndex].examples[exampleIndex]" 
                                        type="text" 
            ...
            <div class="form-check mb-4">
                <input type="checkbox" class="form-check-input" id="isPublishedCheck" v-model="privateState.wordSetModel.isPublished">
                <label class="form-check-label" for="isPublishedCheck">
                    <i v-if="!privateState.wordSetModel.isPublished" class="fas fa-lock"></i>
                    <i v-if="privateState.wordSetModel.isPublished" class="fas fa-lock-open"></i>
                    Publish
                </label>
            </div>
            <loading-button 
                type="submit"
                v-bind:loading="sharedState.loading[privateState.storeTypes.WORD_SET_CREATE] || sharedState.loading[privateState.storeTypes.WORD_SET_UPDATE]"
...
export default {
    ...
    methods: {
        canSearchWordSetImages: function() {
            return this.privateState.wordSetModel.wordsLanguageCode && this.privateState.wordSetModel.name;
        },
        ...
        createWordSet: function() {
            this.$store.dispatch(storeTypes.WORD_SET_CREATE, {
                data: {
