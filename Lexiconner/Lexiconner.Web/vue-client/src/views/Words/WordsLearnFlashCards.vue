    ...
    <div class="row">
      <div class="col-12">
        <row-loader
          v-bind:visible="
            sharedState.loading[
              privateState.storeTypes.WORD_TRAINING_FLASHCARDS_START
            ]
          "
        ></row-loader>
        ...
        <div class="words-learn-flash-cards-wrapper">
          ...
          >
            <img
              ...
              v-bind:src="currentItem.images[0].url"
              v-bind:alt="currentItem.word"
            />
            ...
            <div class="card-bottom-controls">
              ...
              <div class="card-bottom-control-item dropdown">
                ...
                >
                  <button
                    v-on:click="onWordMarkAsLearnedClick(currentItem.id)"
                    class="dropdown-item"
                    type="button"
                  >
              ...
              <span
                v-on:click="onShowAnswerClick()"
                class="card-bottom-control-item text-danger"
              >
                <i class="fas fa-question"></i>
              </span>
              <span
                v-if="!privateState.isShowNextButton"
          ...
          <div class="mt-2">
            <small>
              <div class="text-center">
                <span
                  >{{ privateState.summary.trainedItemsCount }} /
                  {{ privateState.summary.totalItemsCount }}</span
                >
              </div>
              <div>
                <span>
...
export default {
  ...
  computed: {
    ...
    isAllTrained: function () {
      return (
        this.trainingFlashcards !== null &&
        this.trainingFlashcards.items.length === 0
      );
    },
  ...
  methods: {
    loadTraining: function ({ limit = 10 } = {}) {
      return this.$store
        .dispatch(storeTypes.WORD_TRAINING_FLASHCARDS_START, {
    ...
    saveTraining: function () {
      ...
      return this.$store
        .dispatch(storeTypes.WORD_TRAINING_FLASHCARDS_SAVE, {
          data: {
