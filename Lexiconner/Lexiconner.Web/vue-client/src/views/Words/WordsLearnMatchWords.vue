<template>
    <div class="my-permissions-wrapper">
        <div class="row">
            <div class="col-12">
                <row-loader v-bind:visible="sharedState.loading[privateState.storeTypes.WORD_TRAINING_MATCHWORDS_START]" class="mb-2"></row-loader>
                    ...
                    <div v-if="!isAllTrained && trainingMatchWords" class="card bg-light training-card">
                        ...
                        <div class="card-img-top">
                            ...
                            <div class="image-grid image-grid--5images">
                                ...
                                >
                                    <img v-if="item.word.images && item.word.images.length !== 0" class="training-image" v-bind:src="item.word.images[0].url" v-bind:alt="item.word.word">
...
export default {
        ...
        leftOptions: function() {
            if(this.trainingMatchWords) {
                ...
                return this.trainingMatchWords.possibleOptions.filter(x => {
                    return !this.privateState.wordSelectedOptions.some(y => y.randomId === x.randomId);
                });
            }
            return [];
        },
    ...
    methods: {
        loadTraining: function() {
            return this.$store.dispatch(storeTypes.WORD_TRAINING_MATCHWORDS_START, {
        ...
        onShowAnswersClick: function() {
            ...
            const unansweredItems = this.trainingMatchWords.items.filter(x => {
                return !this.privateState.itemResults.some(y => y.itemId === x.word.id);
            });
        ...
        saveTraining: function() {
            ...
            return this.$store.dispatch(storeTypes.WORD_TRAINING_MATCHWORDS_SAVE, {
                data: {
