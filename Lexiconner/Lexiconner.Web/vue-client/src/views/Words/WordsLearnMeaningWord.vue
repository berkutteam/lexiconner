    ...
    <div class="row">
      <div class="col-12">
        <row-loader
          v-bind:visible="
            sharedState.loading[
              privateState.storeTypes.WORD_TRAINING_MEANINGWORD_START
            ]
          "
          class="mb-2"
        ></row-loader>
                  ...
                  <button
                    ...
                    v-bind:class="{
                      'btn-outline-secondary':
                        !privateState.isCurrentItemAnswered ||
                        (privateState.isCurrentItemAnswered &&
                          !possibleOption.isCorrect &&
                          currentItemAnswerOptionIdOrNotSet !==
                            possibleOption.randomId),
                      'btn-success':
                        privateState.isCurrentItemAnswered &&
                        possibleOption.isCorrect,
                      'btn-danger':
...
export default {
  ...
  computed: {
    ...
    isAllTrained: function () {
      return (
        this.trainingMeaningWord !== null &&
        this.trainingMeaningWord.items.length === 0
      );
    },
    ...
    currentItemAnswerOptionIdOrNotSet: function () {
      if (
        ...
        this.privateState.currentItemIndex + 1
      ) {
        return this.privateState.itemResults[this.privateState.currentItemIndex]
          .optionId;
      }
      return null;
    },
  ...
  methods: {
    loadTraining: function () {
      return this.$store
        .dispatch(storeTypes.WORD_TRAINING_MEANINGWORD_START, {
    ...
    saveTraining: function () {
      ...
      return this.$store
        .dispatch(storeTypes.WORD_TRAINING_MEANINGWORD_SAVE, {
          data: {
    ...
    markWordAsLearned: function (wordId) {
      this.$store
        ...
        .then(() => {
          ...
          const possibleOption = this.currentItem.possibleOptions.find(
            (x) => x.isCorrect
          );
          this.handleItemResponse({
            itemId: wordId,
