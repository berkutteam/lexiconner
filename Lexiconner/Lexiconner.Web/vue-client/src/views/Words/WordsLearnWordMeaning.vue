    ...
    <div class="row">
      <div class="col-12">
        <row-loader
          v-bind:visible="
            sharedState.loading[
              privateState.storeTypes.WORD_TRAINING_WORDMEANING_START
            ]
          "
          class="mb-2"
        ></row-loader>
              ...
              <div v-if="privateState.isTrainingFinished" class="mt-2">
                <div>
                  ...
                  <button
                    ...
                    type="button"
                    class="btn custom-btn-normalbtn-sm ml-1"
                  >
                    Train next
...
export default {
  ...
  computed: {
    ...
    isAllTrained: function () {
      return (
        this.trainingWordMeaning !== null &&
        this.trainingWordMeaning.items.length === 0
      );
    },
  ...
  methods: {
    loadTraining: function () {
      return this.$store
        .dispatch(storeTypes.WORD_TRAINING_WORDMEANING_START, {
    ...
    saveTraining: function () {
      ...
      return this.$store
        .dispatch(storeTypes.WORD_TRAINING_WORDMEANING_SAVE, {
          data: {
